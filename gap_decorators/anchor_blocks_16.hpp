...
namespace seqan3 {
    ...
    template <typename inner_type, unsigned short block_size=16>
    ...
    struct anchor_blocks_16
    {

    private:
        using gap_decorator_t   = anchor_blocks_16;
    ...
    public:
        ...
        constexpr anchor_blocks_16()
        {
            data = std::shared_ptr<data_t>(new data_t{});
        };

        constexpr anchor_blocks_16(anchor_blocks_16 const &) = default;

        constexpr anchor_blocks_16 & operator=(anchor_blocks_16 const &) = default;

        constexpr anchor_blocks_16 (anchor_blocks_16 && rhs) = default;

        constexpr anchor_blocks_16 & operator=(anchor_blocks_16 && rhs) = default;

        ~anchor_blocks_16() {data->gap_block_list.clear(); data->gap_sums.clear();};

        constexpr anchor_blocks_16(inner_type * sequence): data{new data_t{sequence}}
        {
