...
namespace seqan3 {
    ...
    template <typename inner_type, unsigned short block_size=64>
    ...
    struct anchor_blocks_64
    {

    private:
        using gap_decorator_t   = anchor_blocks_64;
    ...
    public:
        ...
        constexpr anchor_blocks_64()
        {
            data = std::shared_ptr<data_t>(new data_t{});
        };

        constexpr anchor_blocks_64(anchor_blocks_64 const &) = default;

        constexpr anchor_blocks_64 & operator=(anchor_blocks_64 const &) = default;

        constexpr anchor_blocks_64 (anchor_blocks_64 && rhs) = default;

        constexpr anchor_blocks_64 & operator=(anchor_blocks_64 && rhs) = default;

        ~anchor_blocks_64() {data->gap_block_list.clear(); data->gap_sums.clear();};

        constexpr anchor_blocks_64(inner_type * sequence): data{new data_t{sequence}}
        {
