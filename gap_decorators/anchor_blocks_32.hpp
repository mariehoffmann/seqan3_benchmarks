...
namespace seqan3 {
    ...
    struct anchor_blocks_32
    {

    private:
        using gap_decorator_t   = anchor_blocks_32;
    ...
    public:
        ...
        constexpr anchor_blocks_32()
        {
            data = std::shared_ptr<data_t>(new data_t{});
        };

        constexpr anchor_blocks_32(anchor_blocks_32 const &) = default;

        constexpr anchor_blocks_32 & operator=(anchor_blocks_32 const &) = default;

        constexpr anchor_blocks_32 (anchor_blocks_32 && rhs) = default;

        constexpr anchor_blocks_32 & operator=(anchor_blocks_32 && rhs) = default;

        ~anchor_blocks_32() {data->gap_block_list.clear(); data->gap_sums.clear();};

        constexpr anchor_blocks_32(inner_type * sequence): data{new data_t{sequence}}
        {
