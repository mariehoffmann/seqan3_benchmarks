...
namespace seqan3 {
    ...
    template <typename inner_type, unsigned short block_size=128>
    ...
    struct anchor_blocks_128
    {

    private:
        using gap_decorator_t   = anchor_blocks_128;
    ...
    public:
        ...
        constexpr anchor_blocks_128()
        {
            data = std::shared_ptr<data_t>(new data_t{});
        };

        constexpr anchor_blocks_128(anchor_blocks_128 const &) = default;

        constexpr anchor_blocks_128 & operator=(anchor_blocks_128 const &) = default;

        constexpr anchor_blocks_128 (anchor_blocks_128 && rhs) = default;

        constexpr anchor_blocks_128 & operator=(anchor_blocks_128 && rhs) = default;

        ~anchor_blocks_128() {data->gap_block_list.clear(); data->gap_sums.clear();};

        constexpr anchor_blocks_128(inner_type * sequence): data{new data_t{sequence}}
        {
